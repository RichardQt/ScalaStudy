...
//数组中的方法
object ArrayFunction06 {
  def main(args: Array[String]): Unit = {
    val arr = Array[Int](1, 2, 3, 4)
    val arr1 = Array[Int](5,6)
    val concat_Res = Array.concat(arr,arr1)   //合并数组
    concat_Res.foreach(println)      //输出1到6
    val fii_Res = Array.fill(5)("string")     //填充数组
    fii_Res.foreach(println)
    //
    /*  见方法
    * 1
      ...
      返回数组，第一个参数指定长度，同时每个元素使用第二个参数进行填充。
      7
